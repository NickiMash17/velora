...
# No models are registered against Base yet (Milestone 1 has no business
# logic) — target_metadata is empty until Milestone 2's identity/
# organizations models land. Pointing at it now, rather than at `None`,
# is what makes `alembic revision --autogenerate` immediately useful the
# moment those models exist, with no env.py changes needed then.
